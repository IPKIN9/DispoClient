										...
										<thead>
											<tr role="row">
												...
												<th class="sorting" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1"
													aria-label="Position: activate to sort column ascending" style="width: auto;">Nama Mahasiswa
												</th>
                                                <th class="sorting" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1"
													aria-label="Position: activate to sort column ascending" style="width: auto;">Staff
												</th>
                                                <th class="sorting" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1"
													aria-label="Position: activate to sort column ascending" style="width: auto;">Keterangan
												</th>
                                                <th class="sorting" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1"
													aria-label="Position: activate to sort column ascending" style="width: auto;">Verifikasi
												</th>
											...
											<tr v-for="(ticket, index) in payloadList" :key="index" role="row" class="odd">
												...
												<td>
													<div class="form-button-action">
														<BaseButton @event-click="editTicket" :dataRows="payloadList[index]" data-toggle="tooltip" title="" class="btn-link btn-primary btn-lg"
															data-original-title="Edit Task">
															<i class="fa fa-edit"></i>
														</BaseButton>
														<BaseButton @event-click="deleteTicket" :data-id="ticket.id" data-toggle="tooltip" title="" class="btn-link btn-danger"
				...
				<div class="col-lg-12">
					...
					<div class="form-group">
                        ...
                        <div v-show="mhsPayload.length >= 1" class="list-group list-group-flush">
                            <button class="list-group-item list-group-item-action" v-for="(mhs, index) in mhsPayload" :key="index" @click.stop="changeMhsName({id:mhs.id, nama: mhs.nama})">{{ mhs.nama }}</button>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-show="staffPayload.length >= 1" class="list-group list-group-flush">
                            <button class="list-group-item list-group-item-action" v-for="(staff, index) in staffPayload" :key="index" @click.stop="changeStaffName({id:staff.id, nama: staff.nama})">{{ staff.nama }}</button>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-switch">
                            <input v-model="payload.verifikasi" type="checkbox" class="custom-control-input" id="switch1" name="example">
